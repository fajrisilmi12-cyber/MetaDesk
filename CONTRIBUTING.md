# Contributing to MetaDesk

Thanks for your interest in contributing to MetaDesk!
...
2. Clone your fork:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/MetaDesk.git
   cd MetaDesk
   ```
...
Thank you for helping improve MetaDesk!
