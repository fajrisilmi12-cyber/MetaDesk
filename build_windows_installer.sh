...
#
# Produces:
#   dist_win/MetaDesk.exe                 portable single-file app
#   MetaDesk-Windows-x64-Setup.exe       installer (wizard graphics,
...
METADESK_VERSION="$VERSION" "$PYTHON_BIN" installer/windows/make_wizard_assets.py

echo "== 3/3 compiling installer =="
makensis -DVERSION="$VERSION" -DAPPEXE_PATH="../../dist_win/MetaDesk.exe" \
  installer/windows/MetaDesk.nsi

ls -la MetaDesk-Windows-x64-Setup.exe dist_win/MetaDesk.exe
