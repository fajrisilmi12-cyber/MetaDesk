...
func crashLogPath() string {
	...
	case "darwin":
		...
		return filepath.Join(home, "Library", "Application Support", "MetaDesk", "wa_crash.log")
	case "windows":
		return filepath.Join(os.Getenv("APPDATA"), "MetaDesk", "wa_crash.log")
	default:
		home, err := os.UserHomeDir()
		if err != nil {
			home = "."
		}
		return filepath.Join(home, ".config", "metadesk", "wa_crash.log")
	}
}
