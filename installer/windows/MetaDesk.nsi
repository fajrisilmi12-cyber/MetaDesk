; MetaDesk — Windows installer (NSIS, per-user, no admin required).
;
...
;   makensis -DVERSION=1.0.0 -DAPPEXE_PATH=dist_win\MetaDesk.exe installer\windows\MetaDesk.nsi
; Output: MetaDesk-Windows-x64-Setup.exe (repo root).

Target x86-ansi

!define APPNAME "MetaDesk"
!define APPID "MetaDesk"
!define COMPANY "MetaDesk"
!define APPURL "https://github.com/fajrisilmi12-cyber/MetaDesk"
!define APPEXE "MetaDesk.exe"
...
OutFile "../../MetaDesk-Windows-x64-Setup.exe"
...
; Uninstall
; ---------------------------------------------------------------------------
!define MUI_UNCONFIRMPAGE_TEXT_TOP "This removes ${APPNAME} from your computer. Your MetaDesk chats and settings can be kept."
...
Section "Uninstall"
  ...
  MessageBox MB_YESNO|MB_ICONQUESTION \
    "Also delete your MetaDesk profile (login session, cache and settings)?$\r$\n$\r$\nChoose No to keep your session for a future reinstall." \
    IDNO skip_profile
