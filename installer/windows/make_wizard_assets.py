#!/usr/bin/env python3
"""Generates the NSIS wizard graphics for the MetaDesk Windows installer.
...
def build_welcome():
    ...
    chip = "v" + os.environ.get("METADESK_VERSION", "1.5.9.8")
...
def build_header():
    ...
    d.text((12, 15), "MetaDesk", font=name_font, fill=TEXT)
