...
func getOnboardingScript() string {
	return `
		(function() {
			var ONBOARDING_KEY = 'metadesk_onboarded_v4';
			...
			function showOnboarding(force) {
				...
				intro.innerHTML = '<div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;">' +
					...
					'<h1 id="wa-onboarding-title" style="font-size:18px;line-height:1.3;font-weight:600;letter-spacing:-.15px;margin:0;">MetaDesk is ready</h1>' +
					'</div>' +
				...
				continueButton.textContent = 'Continue to MetaDesk';
