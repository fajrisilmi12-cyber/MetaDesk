...
func getDefaultDownloadDir() string {
	...
	return filepath.Join(home, "Downloads", "MetaDesk Downloads")
}
...
func getSettingsFilePath() string {
	...
	if runtime.GOOS == "darwin" {
		...
		baseDir = filepath.Join(home, "Library", "Application Support", "MetaDesk")
	} else {
		...
		baseDir = filepath.Join(configDir, "MetaDesk")
	}
...
func isAllowedOpenPath(filePath string) bool {
	...
	previewDir := filepath.Join(os.TempDir(), "MetaDeskPreview")
...
func previewDocument(filename, dataURI string) (string, error) {
	tempDir := filepath.Join(os.TempDir(), "MetaDeskPreview")
